...
Frame data comes from the **[TekkenDocs](https://tekkendocs.com/)** project / **[Wavu Wiki](https://wavu.wiki/)** and is used with attribution. Frame values reflect the current patch (Season 3). Wavu content is licensed under **CC BY-SA 4.0**.
